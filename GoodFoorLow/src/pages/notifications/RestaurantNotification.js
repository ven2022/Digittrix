...
class RestaurantNotification extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <div>
        <h1>Send Notification To Restaurant</h1>
...
export default withRouter(RestaurantNotification);
