...
class terms extends React.Component {
  ...
  {
    try{
       let response= await Api.pageById('6217674ef8c91e3c1599664f');
...
if(this.state.loadings==false)
{
    ...
    this.setState({loadings:true},async()=>
    {
      ...
      const response= await Api.pageUpdateById('6217674ef8c91e3c1599664f',formData);
  ...
  render() {
    return (
      <div>
        <h1>Update Terms & Conditions Page</h1>
        <Row>
          <Col sm={12}>
            <Widget
